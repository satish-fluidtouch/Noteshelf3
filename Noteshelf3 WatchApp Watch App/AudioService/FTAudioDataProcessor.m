//
//  NSObject+FTAudioDataProcessor.m
//  Noteshelf3
//
...
#import "Noteshelf3_WatchApp-Swift.h"
...
- (void)startProcessingAudioData:(BOOL)isToResume{
    ...
    if(!isToResume){
        AVAudioFormat *audioFormat = [self.audioTapNode outputFormatForBus:0];
        [self.audioTapNode installTapOnBus:0
                                bufferSize:4096
                                    format:audioFormat
