...
class FTPlannerDiaryTrackerTemplateFormat  :FTPlannerDiaryTemplateFormat {
    ...
    private func renderiPadTemplate(context : CGContext){
        ...
        let habitColorbandsDict = isDarkTemplate ? darkModeMonthStripColors : monthStripColors
        for index in 1...6 {
