...
class FTPlannerDiaryDayTemplateFormat : FTPlannerDiaryTemplateFormat {
    ...
    private func renderiPadTemplate(context : CGContext){
        ...
        let startingYAxis : CGFloat = isLandscaped ? 17.92 : 13.36
        ...
        let toDoCircleBGColor = isDarkTemplate ? UIColor(hexString: "#131313") : UIColor(hexString: "#FEFEFE")
        for color in toDoColors {
            let bandColor = isDarkTemplate ? UIColor(hexString: color) : UIColor(hexString: color,alpha: 0.5)
        ...
        let scheduleBandBGColor = isDarkTemplate ? UIColor(hexString: "#B27D6F") : UIColor(hexString: "#F0CBC2")
        ...
        let notesYAxisPercnt : CGFloat = isLandscaped ? 73.07 : 65.17
