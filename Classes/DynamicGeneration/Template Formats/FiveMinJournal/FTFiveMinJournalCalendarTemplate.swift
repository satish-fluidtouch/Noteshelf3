//
//  FTFiveMinJournalCalendarTemplate.swift
//  Noteshelf
//
//  Created by Ramakrishna on 06/07/21.
//  Copyright © 2021 Fluid Touch Pte Ltd. All rights reserved.
//

import Foundation

class FTFiveMinJournalCalendarTemplate : FTFiveMinJournalTemplateFormat {
    ...
    private func renderiPadTemplate(context : CGContext){
        let isLandscaped = templateInfo.customVariants.isLandscape
        boxWidth = isLandscaped ? 21.41 : 28.41
        boxHeight = isLandscaped ? 25.31 : 19.69
        startingXAxis = isLandscaped ? 3.68 : 5.15
        startingYAxis = isLandscaped ? 14.28 : 11.83
        horizontalGapBWBoxes = isLandscaped ? 2.34 : 2.39
        verticalGapBWBoxes = isLandscaped ? 2.33 :1.79
