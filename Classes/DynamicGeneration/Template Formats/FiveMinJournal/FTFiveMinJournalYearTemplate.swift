//
//  FTFiveMinJournalYearTemplate.swift
//  Noteshelf
//
//  Created by Ramakrishna on 26/07/21.
//  Copyright © 2021 Fluid Touch Pte Ltd. All rights reserved.
//
import Foundation
import PDFKit

class FTFiveMinJournalYearTemplate : FTFiveMinJournalTemplateFormat {
    ...
    private func renderiPhoneTemplate(context : CGContext){
        ...
        boxWidth = isLandscaped ? 22.18 : 28.19
        boxHeight = isLandscaped ? 20.24 : 19.84
        startingXAxis = isLandscaped ? 3.14 : 5.33
        startingYAxis = isLandscaped ? 20.84 : 10.35
        horizontalGapBWBoxes = isLandscaped ? 1.64 : 2.37
        verticalGapBWBoxes =  isLandscaped ? 3.12 : 1.81
