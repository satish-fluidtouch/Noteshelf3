//
//  FTCollectionViewWaterfallLayout.swift
//  DailyNotes
//
//  Created by Siva Kumar Reddy on 13/08/20.
//  Copyright © 2020 Amar. All rights reserved.
//
...
@objc public protocol FTCollectionViewDelegateWaterfallLayout: UICollectionViewDelegate {
...
@available(*, unavailable, renamed: "FTCollectionViewWaterfallLayout.ItemRenderDirection")
public enum FTCollectionViewWaterfallLayoutItemRenderDirection { }

public extension FTCollectionViewWaterfallLayout.ItemRenderDirection {
    @available(*, unavailable, renamed: "shortestFirst")
    static let ftCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst = 0
    @available(*, unavailable, renamed: "leftToRight")
    static let ftCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight = 1
    @available(*, unavailable, renamed: "rightToLeft")
    static let ftCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft = 2
}

extension FTCollectionViewWaterfallLayout {
...
public let FTCollectionElementKindSectionHeader = "FTCollectionElementKindSectionHeader"
@available(*, unavailable, renamed: "UICollectionView.elementKindSectionFooter")
public let FTCollectionElementKindSectionFooter = "FTCollectionElementKindSectionFooter"
public class FTCollectionViewWaterfallLayout: UICollectionViewLayout {
    ...
    public var delegate: FTCollectionViewDelegateWaterfallLayout? {
        get {
            return collectionView!.delegate as? FTCollectionViewDelegateWaterfallLayout
        }
    }
