...
final class FTCalPenBrushBuilder_V3: FTBrushProtocol {
    ...
    static func brushImageFor(brushWidth: CGFloat, scale: CGFloat) -> UIImage {
        ...
        case 5:
            switch (zoomScale) {
            case 1:
                imageName = "BrushAsset_v3/cal-brush-size4-1"
            case 2:
                imageName = "BrushAsset_v3/cal-brush-size4-2"
            default:
                imageName = "BrushAsset_v3/cal-brush-size4-3"
            }
        case 6:
            imageName = "BrushAsset_v3/cal-brush-size5-1"
        case 7:
            imageName = "BrushAsset_v3/cal-brush-size6-1"
        case 8:
            imageName = "BrushAsset_v3/cal-brush-size7-1"
        default:
            imageName = "BrushAsset_v3/cal-brush-5"
        }
        guard let image:UIImage = UIImage(named:imageName) else {
            return UIImage(named:"BrushAsset_v3/cal-brush-5")!
        }
        return image
    }
