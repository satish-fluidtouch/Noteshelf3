...
final class FTMarkerBrushBuilder_V2: FTBrushProtocol {
    ...
    static func brushImageFor(brushWidth: CGFloat, scale: CGFloat) -> UIImage {
        ...
        if brushWidth < 4 {
            ...
            switch (scaleInt) {
                case 1:
                    highImage = UIImage(named:"BrushAsset_v2/marker-1")!
                case 2:
                    highImage = UIImage(named:"BrushAsset_v2/marker-2")!
                case 3:
                    highImage = UIImage(named:"BrushAsset_v2/marker-3")!
                default:
                    highImage = UIImage(named:"BrushAsset_v2/marker-3")!
            }
        }
...
private extension FTMarkerBrushBuilder_V2 {
    static func circularBrushImageForWidth(_ brushWidth:CGFloat, scale:CGFloat) -> UIImage {
        ...
        guard let glossGradient = CGGradient(colorSpace: colorSpace, colorComponents: components, locations: locations, count: num_locations) else {
            ...
            FTLogError("marker_glossGradient_fail_v2")
        ...
        if let cgImage = brushContext?.makeImage() {
            ...
            FTLogError("marker_texture_fail_v2")
