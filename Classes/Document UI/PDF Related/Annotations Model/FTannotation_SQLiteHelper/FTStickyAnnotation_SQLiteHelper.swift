...
let stickyInsertQuery = "INSERT INTO annotation (id,annotationType,boundingRect_x,boundingRect_y,boundingRect_w,boundingRect_h,screenScale,createdTime,modifiedTime,emojiName,isReadonly,version)VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
