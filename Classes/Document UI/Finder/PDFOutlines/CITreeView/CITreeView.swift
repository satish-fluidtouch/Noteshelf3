...
public class CITreeView: UITableView {
    ...
    public func expandCollapseRow(at indexPath: IndexPath) {
    ...
    func expandOpenedRows(){
        treeViewController.expandOpenedRows()
...
extension CITreeView: UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let selectedTreeViewNode = treeViewController.getTreeViewNode(atIndex: indexPath.row)
        self.treeViewDelegate?.treeView(self, didSelectRowAt: selectedTreeViewNode, at: indexPath)
    }
}
