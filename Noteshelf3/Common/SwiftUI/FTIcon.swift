...
extension FTIcon {
    ...
    static let saveAsTemplate = FTIcon(bundleName: "doc.richtext")
    static let rotateRight = FTIcon(bundleName: "rotate.left")
    static let rotateLeft = FTIcon(bundleName: "rotate.right")
    static let textMagnifyingglass = FTIcon(systemName: "doc.text.magnifyingglass")
    static let arrowCounterclockwise = FTIcon(bundleName: "arrow.counterclockwise")
    ...
    static let gearShape = FTIcon(bundleName:"gearshape")
