...
//  Noteshelf3
//
//  Created by Narayana on 09/01/23.
...
extension UIHostingController {
    // This is temporary solution to avoid content move up/down during keyboard appear/disappear cases.
    // Once we get better solution, should be removed below and do cleanup of used areas.
